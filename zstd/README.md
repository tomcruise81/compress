...
Install using `go get -u github.com/tomcruise81/compress`. The package is located in `github.com/tomcruise81/compress/zstd`.

[![Go Reference](https://pkg.go.dev/badge/github.com/tomcruise81/compress/zstd.svg)](https://pkg.go.dev/github.com/tomcruise81/compress/zstd)
...
used by several projects. This library is being [fuzz-tested](https://github.com/tomcruise81/compress-fuzz) for all updates.
...
```Go
import "github.com/tomcruise81/compress/zstd"
...
This library is being continuously [fuzz-tested](https://github.com/tomcruise81/compress-fuzz),
...
See [this example](https://pkg.go.dev/github.com/tomcruise81/compress/zstd#example-ZipCompressor) for
